...
switch ($op) {
    ...
    case 'view':
        ...
        echo '<tr><td style="padding:8px; font-weight:bold; vertical-align:top;">' . _AM_REALESTATE_MESSAGE_BODY . '</td><td style="padding:8px;">' . \nl2br(\htmlspecialchars((string)$msg->getVar('body', 's'), ENT_QUOTES)) . '</td></tr>';
        echo '</table>';
